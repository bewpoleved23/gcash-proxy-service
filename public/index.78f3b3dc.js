  ...
  */ !function(t, e) {
    ...
    class cn extends z {
        ...
        show() {
            ...
            if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(i), P.trigger(this._element, this.constructor.eventName("inserted"))), this._popper ? this._popper.update() : this._popper = this._createPopper(i), i.classList.add(tn), "ontouchstart" in document.documentElement) for (const t1 of [].concat(...document.body.children))P.on(t1, "mouseover", h);
            this._queueCallback(()=>{
        ...
        hide() {
            ...
            if (t.classList.remove(tn), "ontouchstart" in document.documentElement) for (const t1 of [].concat(...document.body.children))P.off(t1, "mouseover", h);
...
//# sourceMappingURL=index.78f3b3dc.js.map
